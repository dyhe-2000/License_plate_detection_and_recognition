...
parser.add_argument("-image", help='image path', default='../../ccpd/CCPD_base+weather+green', type=str)
...
parser.add_argument("-size", help='the number of images to be saved', default=215764, type=int)
...
print("save_dir_train: ", save_dir_train)
print("save_dir_val: ", save_dir_val)
